...
\title{%
  Experiment Design aus Literatur
}
%\thesis{master}
...
\begin{figure}[H]
  ...
  \ffigbox[\FBwidth]{%
    \begin{subfloatrow}[2]
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=3cm]{./Bilder/Results of simulating different electrode force}}}{\caption{Results of simulating different electrode force}}
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=3cm]{./Bilder/Results of simulating different size of the electrode tip}}}{\caption{Results of simulating different size of the electrode tip}}
    \end{subfloatrow}

    \begin{subfloatrow}[2]
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=3cm]{./Bilder/Results of simulating different welding current}}}{\caption{Results of simulating different welding current}}
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=3cm]{./Bilder/Results of simulating different welding time}}}{\caption{Results of simulating different welding time}}
    \end{subfloatrow}
    }
	{%
    \caption{The best welding parameters selected by ANN}\label{fig:label}%
  }
\end{figure}
...
\begin{figure}[H]
  ...
  \ffigbox[\FBwidth]{%
    \begin{subfloatrow}[2]
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=5cm]{./Bilder/Five types of standard electrode force pattern}}}{\caption{Five types of standard electrode force pattern}}
      \ffigbox[\FBwidth]{%
        \fbox{\includegraphics[height=5cm]{./Bilder/The standard force slope patterns}}}{\caption{The standard force slope patterns}}
    \end{subfloatrow}
    }
	{%
    \caption{Select slope feature from force pattern and used in ANN input }\label{fig:label}%
  }
\end{figure}
\begin{figure}[H]
\centering
